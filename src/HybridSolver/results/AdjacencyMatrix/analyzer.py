...
def analyze(abs_dir):
    ...
    std_explored_bbnodes = (sum([(x - mean_explored_bbnodes) ** 2 for x in explored_bbnodes_list]) / num_resolved) ** 0.5
    ...
    std_bbnodes_before_best = (sum([(x - mean_bbnodes_before_best) ** 2 for x in bbnodes_before_best_list]) / num_resolved) ** 0.5
    ...
    with open(output_filename, 'w') as f:
        ...
        f.write("Mean BBNodes before best: " + str(mean_bbnodes_before_best) + " +- " + str(std_bbnodes_before_best) + "\n")
